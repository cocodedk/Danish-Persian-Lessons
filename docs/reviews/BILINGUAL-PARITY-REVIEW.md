...
The audit covered all 179 typed catalog entries, the three connected microtexts, every dynamic
...
11. The seven word bridges state whether the modern meanings match. بند/bånd is a true old link;
