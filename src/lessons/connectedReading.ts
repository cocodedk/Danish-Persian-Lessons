...
export const connectedTexts: ConnectedReading[] = [
  ...
  microtext('3', 'این خانه است. آسمان آبی است. ماه زرد است. شب است.', 'این خانه اَست. آسِمان آبی اَست. ماه زَرد اَست. شَب اَست.', 'Dette er et hus. Himlen er blå. Månen er gul. Det er nat.', 'in khåne ast. åsemån åbi ast. måh zard ast. sjab ast', 'iːn xɒːne æst. ɒːsemɒːn ɒːbiː æst. mɒːh zæɾd æst. ʃæb æst', [...vocab('1', 'in', 'abi'), ...vocab('3', 'khane', 'aseman', 'mah', 'zard', 'shab')], ['Dette er et hus. Himlen er blå. Månen er gul. Det er nat.', 'Det er en skole med en ven.', 'Det handler om mor og far.']),
]
