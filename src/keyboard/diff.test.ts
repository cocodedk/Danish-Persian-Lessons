...
describe('normalizing before the comparison', () => {
  it('never asks for اِعراب — the keyboard cannot type it, so it cannot be required', () => {
    ...
    expect(compare(fa, faMarked)).toEqual({ kind: 'match', index: -1 })
